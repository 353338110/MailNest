...
2. **`codex/mail-actions`**：删除、星标、标记未读、移动文件夹和批量操作
3. **`codex/gmail-mail-provider`**：Gmail 邮件列表、详情和发信
4. **`codex/desktop-mobile-polish`**：键盘快捷键、右键菜单和更完整的加载/确认状态
